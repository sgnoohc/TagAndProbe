...
tnp_parameters = cms.PSet(
	...
	output_label = cms.string("MuonID_Soft9Jun16"),
...
#	pt_bins   = cms.vdouble(5, 10, 25, 40, 50, 200),
	pt_bins   = cms.vdouble(5, 10, 20),
	eta_bins  = cms.vdouble(0., 1.5, 2.4),
...
#        activity_bins = cms.vdouble(0.005, 0.02, 0.05, 0.15, 1, 10.0), #first bin != 0 otherwise not drawn in log plot
	...
	numerator   = cms.string("MuSoftIso"),
...
process.tnp_make_plots.suffix = cms.string("pdf") 
