...
tnp_parameters = cms.PSet(
	...
	output_label = cms.string("ElectronID_EGammaPFElectron"),
...
#	pt_bins   = cms.vdouble(10, 20, 30, 40, 50, 200),
	...
	eta_bins  = cms.vdouble(0, 1.479, 2.5),
...
#	nvtx_bins = cms.vdouble(0, 5, 10, 15, 20, 25, 30, 35, 40),
	...
	numerator   = cms.string("EGammaPFElectronChIso"  ),
#	denominator = cms.string("EGammaGsfElectron"),
	denominator = cms.string("EGammaPFElectron"),
