...
#	output_label = cms.string("ElectronID_softClean4signalSyst"),
#	output_label = cms.string("ElectronID_softClean4"),
#	output_label = cms.string("ElectronID_softClean4tag30Syst"),
#	output_label = cms.string("ElectronID_softClean4notCleanSyst"),
	output_label = cms.string("ElectronID_softClean4factorize"),
...
#	nvtx_bins = cms.vdouble(0, 5, 10, 15, 20, 25, 30, 35, 40),
	...
	numerator   = cms.string("EGammaSoftIso"),
#	denominator = cms.string("EGammaGsfElectron"),
	denominator = cms.string("EGammaSoftIDLike"),
#	denominator = cms.string("EGammaSoftISOLike"),
...
#		"MCTemplateCB"   , "MCTemplateCB"   , "Exponential"  , "Exponential"  , # pt5
	),
	
	## models for eta bins 
	eta_models = cms.vstring( 
	#          sig pass,        sig fail,      bkg pass,      bkg fail
		"MCTemplateCB"   , "MCTemplateCB"   , "Exponential"  , "Exponential", # eta2  
		"MCTemplateCB"   , "MCTemplateCB"   , "Exponential"  , "Exponential", # eta3
		"MCTemplateCB"   , "MCTemplateCB"   , "Exponential"  , "Exponential", # eta4
#		"MCTemplateCB"   , "MCTemplateCB"   , "Exponential"  , "Exponential", # eta2  
#		"MCTemplateCB"   , "MCTemplateCB"   , "Exponential"  , "Exponential", # eta3
...
#		"MCTemplateCB"   , "MCTemplateCB"   , "ErfExp", "ErfExp",
#		"MCTemplateCB"   , "MCTemplateCB"   , "ErfExp", "ErfExp",
#		"MCTemplateCB"   , "MCTemplateCB"   , "ErfExp", "ErfExp",
#		"MCTemplateCB"   , "MCTemplateCB"   , "ErfExp", "ErfExp",
#		"MCTemplateCB"   , "MCTemplateCB"   , "ErfExp", "ErfExp",
...
#		"BreitWignerCBMCpar"   , "BreitWignerCBMCpar"   , "Exponential", "Exponential",
#		"BreitWignerCBMCpar"   , "BreitWignerCBMCpar"   , "Exponential", "Exponential",
#		"BreitWignerCBMCpar"   , "BreitWignerCBMCpar"   , "Exponential", "Exponential",
#		"BreitWignerCBMCpar"   , "BreitWignerCBMCpar"   , "Exponential", "Exponential",
#		"BreitWignerCBMCpar"   , "BreitWignerCBMCpar"   , "Exponential", "Exponential",
...
#		"BreitWignerCB"   , "BreitWignerCB"   , "Linear", "Linear",
#		"BreitWignerCB"   , "BreitWignerCB"   , "Linear", "Linear",
#		"BreitWignerCB"   , "BreitWignerCB"   , "Linear", "Linear",
#		"BreitWignerCB"   , "BreitWignerCB"   , "Linear", "Linear",
#		"BreitWignerCB"   , "BreitWignerCB"   , "Linear", "Linear",
...
#		"BreitWignerCB"   , "BreitWignerCB"   , "Exponential", "Exponential",
#		"MCTemplateCB"   , "MCTemplateCB"   , "Exponential", "Exponential",
#		"MCTemplateCB"   , "MCTemplateCB"   , "Exponential", "Exponential",
#
#		"MCTemplateCB"   , "MCTemplateCB"   , "Exponential", "Exponential",
